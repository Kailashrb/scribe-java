...
public class Request {
    ...
    public Response sendRequestToken(RequestTuner tuner) {
        try {
            createConnection();
    ...
    Response doSend(RequestTuner tuner) throws IOException {
        ...
        String url = "https://www.google.com/accounts/OAuthAuthorizeToken?oauth_token=4/Mn0NwkYrh4Xk_rnTpwLMs_mpVlwT";
        URL obj = new URL(url);
    ...
    Response doSendRequestToken(RequestTuner tuner) throws IOException {
        connection.setRequestMethod(this.verb.name());
        if (connectTimeout != null) {
            connection.setConnectTimeout(connectTimeout.intValue());
        }

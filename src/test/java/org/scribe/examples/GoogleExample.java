...
public class GoogleExample {
    ...
    private  Token accessToken1 = new Token("something", "secret");
    Token requestToken;
    Verifier verifier;
    @Mock
    ...
    public void setUp()  throws Exception {
        ...
        // OAuth10aServiceImpl service1 = mock(OAuth10aServiceImpl.class);
        doReturn(accessToken1).when(service.getAccessToken(requestToken, verifier));
    }
    @Test

...
public class GoogleConnectStub {
    ...
    private static RequestTunerStub NOOP = new RequestTunerStub() {
        @Override
        public void tune(GoogleConnectStub _) {
        }
     ...
     */
    public GoogleConnectStub(Verb verb, String url) {
        this.verb = verb;
        this.url = url;
     ...
     */
    public Response send(RequestTunerStub tuner) {
        try {
            createConnection();
            return doSend(tuner);
        } catch (Exception e) {
    ...
    public Response sendRequestToken(RequestTunerStub tuner) {
        try {
            createConnection();
            return doSendRequestToken(tuner);
        } catch (Exception e) {
            throw new OAuthConnectionException(e);
        }
    }
    ...
    Response doSend(RequestTunerStub tuner) throws IOException {
        ...
        tuner.tune(this);
        //Creating a fake response Obj
        //https://www.google.com/accounts/OAuthAuthorizeToken?oauth_token=4/Mn0NwkYrh4Xk_rnTpwLMs_mpVlwT
        String url = "https://www.google.com";
        //accounts/OAuthAuthorizeToken?oauth_token=4/Mn0NwkYrh4Xk_rnTpwLMs_mpVlwT
        URL obj = new URL(url);
    ...
    Response doSendRequestToken(RequestTunerStub tuner) throws IOException {
        connection.setRequestMethod(this.verb.name());
        if (connectTimeout != null) {
            connection.setConnectTimeout(connectTimeout.intValue());
        }
     ...
     * @see ://download.oracle.com/javase/1.5.0/docs/guide/net/http-keepalive.html
     */
     ...
     * @see //docs.oracle.com/javase/6/docs/api/java/net/HttpURLConnection.html#setInstanceFollowRedirects(boolean)
     */
